...
$implementationRoot = Join-Path $repoRoot 'implementation\v02'
$copybookDirectory = Join-Path $implementationRoot 'copybook'

if (-not $OutputDirectory) {
    $OutputDirectory = Join-Path $repoRoot 'build\v02'
}
...
Write-Host "V2 COBOL programs built in: $OutputDirectory"
