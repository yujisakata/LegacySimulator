...
| V4 | 終身・特約／医療系に施行日・再告知を追加したCOBOL | 統合800件＋逆順・継承・受付・異常系。[成果物入口](specification/requirements/v04/README.md) |
| V5 | V4実出力からJava/JDBC照会へ夜間複製 | 実Java・DB・HTTPの101検証＋誤変更3件。[作成過程と成果物](specification/requirements/v05/README.md) |
